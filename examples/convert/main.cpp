...
int convert_sd3(const convert_params& params) {
    ModelLoader loader;
    bool loaded = false;
...
int convert_flux(const convert_params& params) {
    ModelLoader loader;
    bool loaded = false;
...
int convert_sdxl(const convert_params& params) {
    ModelLoader loader;
    bool loaded = false;
...
int convert_sd(const convert_params& params) {
    ModelLoader loader;
    bool loaded = false;
...
int main(int argc, char** argv) {
    ...
    if (class_name == "StableDiffusion3Pipeline") {
        ...
        ver = VERSION_FLUX_FILL;
    } else if (class_name == "StableDiffusionXLPipeline") {
        ver = VERSION_SDXL;
    } else if (class_name == "StableDiffusionXLImg2ImgPipeline") {
        ver = VERSION_SDXL_REFINER;
    } else if (class_name == "StableDiffusionXLInpaintPipeline") {
        ver = VERSION_SDXL_INPAINT;
    } else if (class_name == "StableDiffusionPipeline" || class_name == "StableDiffusionInpaintPipeline") {
        ...
        if (hidden_size == 1024) {
            ver = VERSION_SD2;
            if (class_name == "StableDiffusionInpaintPipeline") {
                ver = VERSION_SD2_INPAINT;
            }
        } else {
            ver = VERSION_SD1;
            if (class_name == "StableDiffusionInpaintPipeline") {
                ver = VERSION_SD1_INPAINT;
            }
        }
    }
